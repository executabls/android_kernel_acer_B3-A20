...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x95 , 0x78);
	...
	GC2145_write_cmos_sensor(0x82 , 0x18);//0x05 jon
	GC2145_write_cmos_sensor(0x83 , 0x15);//0x08 jon
	...
	/////////////////////////////////////////////// 
	GC2145_write_cmos_sensor(0xfe , 0x02);
	GC2145_write_cmos_sensor(0xd0 , 0x48);
	GC2145_write_cmos_sensor(0xd1 , 0x35);
	GC2145_write_cmos_sensor(0xd2 , 0x35);
	GC2145_write_cmos_sensor(0xd3 , 0x4d);//0x40 jon
	GC2145_write_cmos_sensor(0xd5 , 0xf0);//add jon
  ...
  GC2145_write_cmos_sensor(0x4d , 0x30);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x50);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x70);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  ...
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x2f);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x4f);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  ...
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x2e);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  GC2145_write_cmos_sensor(0x4d , 0x4e);
  GC2145_write_cmos_sensor(0x4e , 0x02);
  GC2145_write_cmos_sensor(0x4c , 0x01);
  ...
  GC2145_write_cmos_sensor(0x4e , 0x02);
	...
	GC2145_write_cmos_sensor(0xc3 , 0x0e);
	...
	GC2145_write_cmos_sensor(0x06 , 0x31);
	GC2145_write_cmos_sensor(0x07 , 0x00);
	GC2145_write_cmos_sensor(0x08 , 0x20);
	GC2145_write_cmos_sensor(0xfe , 0x01);
	GC2145_write_cmos_sensor(0x25 , 0x01);
	GC2145_write_cmos_sensor(0x26 , 0x02);
	GC2145_write_cmos_sensor(0x27 , 0x04);
	GC2145_write_cmos_sensor(0x28 , 0x08);
	GC2145_write_cmos_sensor(0x29 , 0x04);
	GC2145_write_cmos_sensor(0x2a , 0x08);
	GC2145_write_cmos_sensor(0x2b , 0x04);
	GC2145_write_cmos_sensor(0x2c , 0x08);
	GC2145_write_cmos_sensor(0x2d , 0x04);
	GC2145_write_cmos_sensor(0x2e , 0x08);
	GC2145_write_cmos_sensor(0xfe , 0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorStillCaptureFrameRate=16;
	...
	pSensorInfo->VideoDelayFrame = 2; //add clj 20150626
...
BOOL GC2145_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145_write_cmos_sensor(0xfe , 0x00);
		GC2145_write_cmos_sensor(0x05 , 0x01);
		GC2145_write_cmos_sensor(0x06 , 0x0c);
		GC2145_write_cmos_sensor(0x07 , 0x00);
		GC2145_write_cmos_sensor(0x08 , 0x20);
		GC2145_write_cmos_sensor(0xfe , 0x01);
		GC2145_write_cmos_sensor(0x25 , 0x00);
		GC2145_write_cmos_sensor(0x26 , 0xde);
		GC2145_write_cmos_sensor(0x27 , 0x05);
		GC2145_write_cmos_sensor(0x28 , 0x34);
		GC2145_write_cmos_sensor(0x29 , 0x05);
		GC2145_write_cmos_sensor(0x2a , 0x34);
		GC2145_write_cmos_sensor(0x2b , 0x05);
		GC2145_write_cmos_sensor(0x2c , 0x34);
		GC2145_write_cmos_sensor(0x2d , 0x05);
		GC2145_write_cmos_sensor(0x2e , 0x34);
		GC2145_write_cmos_sensor(0xfe , 0x00);
            break;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_CHECK_SENSOR_ID:
			//modify clj 20150730
			GC2145_GetSensorID(feature_data);
